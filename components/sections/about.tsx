          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-muted-foreground">
                I’m Parmesh Bhatt, Ex - Cloud Captain at AWS Cloud Club Charusat and a fourth-year B.Tech student at Charusat University, Gujarat, India. 
              </p>
              <p className="text-lg text-muted-foreground">
              Passionate about web development, DevOps, and cloud computing, I’ve led the WebDev team at DeCodeCafe and contributed as a Cloud Developer at CLDC. I’ve also worked on open-source projects, including contributing to the Charusatv4 and Charusatv5 websites.
              </p>
              <p className="text-lg text-muted-foreground">
