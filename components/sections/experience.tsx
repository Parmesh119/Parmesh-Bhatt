...
const experiences = [
  {
    ...
    description: "Led the development of enterprise-level web applications using Next.js and Node.js. Managed a team of 5 developers and implemented CI/CD pipelines.",
    skills: ["Next.js", "React.Js", "Node.js", "AWS", "Docker", "Java", "Kotlin", "Spring Boot", "Kubernetes", "JS", ],
  },
  {
    title: "Cloud Captain",
